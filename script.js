...
const textArray = ["Web Designer", "Graphic Designer", "Developer", "Freelancer"];
...
// Toggle the "More About Me" section
...
document.querySelectorAll('.more-projects-btn').forEach(button => {
